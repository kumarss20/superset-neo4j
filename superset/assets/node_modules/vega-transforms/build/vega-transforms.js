(function (global, factory) {
  ...
  var prototype$h = vegaUtil.inherits(KDE, vegaDataflow.Transform);
  ...
  prototype$h.transform = function(_, pulse) {
    ...
    if (!this.value || pulse.changed() || _.modified()) {
      ...
      groups.forEach(g => {
        ...
        vegaStatistics.sampleCurve(density, domain, minsteps, maxsteps).forEach(v => {
          const t = {};
  ...
  var prototype$i = vegaUtil.inherits(Load, vegaDataflow.Transform);
  ...
  var prototype$j = vegaUtil.inherits(Lookup, vegaDataflow.Transform);
  ...
  var prototype$k = vegaUtil.inherits(Pivot, Aggregate);

  prototype$k._transform = prototype$k.transform;
  ...
  var prototype$l = vegaUtil.inherits(PreFacet, Facet);
  ...
  var prototype$m = vegaUtil.inherits(Project, vegaDataflow.Transform);
  ...
  var prototype$n = vegaUtil.inherits(Proxy, vegaDataflow.Transform);
  ...
  var prototype$o = vegaUtil.inherits(Relay, vegaDataflow.Transform);
  ...
  var prototype$p = vegaUtil.inherits(Sample, vegaDataflow.Transform);
  ...
  var prototype$q = vegaUtil.inherits(Sequence, vegaDataflow.Transform);
  ...
  var prototype$r = vegaUtil.inherits(Sieve, vegaDataflow.Transform);
  ...
  var prototype$s = vegaUtil.inherits(TupleIndex, vegaDataflow.Transform);
  ...
  var prototype$t = vegaUtil.inherits(Values, vegaDataflow.Transform);
  ...
  const prototype$u = WindowState.prototype;
  ...
  prototype$u.update = function(w, t) {
    let self = this,
        cell = self.cell,
        wind = self.windows,
        data = w.data,
  ...
  var prototype$v = vegaUtil.inherits(Window, vegaDataflow.Transform);
  ...
  prototype$v.group = function(key) {
    var self = this,
