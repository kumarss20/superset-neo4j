...
const StyledDangerButton = _Button.default.extendStyles((_ref) => {
  let {
    color
  } = _ref;
  return {
...
function DangerButton(_ref2) {
  let {
    children
  } = _ref2,
      props = _objectWithoutPropertiesLoose(_ref2, ["children"]);

  return _react.default.createElement(StyledDangerButton, props, children);
}