...
var _interweaveEmojiPicker = require("interweave-emoji-picker");
...
const styleSheet = (_ref) => {
  ...
  return {
    ...
    skinTone: {
      ...
      }, Object.keys(_interweaveEmojiPicker.SKIN_COLORS).reduce((colors, key) => _extends({}, colors, {
        ["[data-skin-tone=\"" + key + "\"]"]: {
          backgroundColor: _interweaveEmojiPicker.SKIN_COLORS[key],
          borderColor: _interweaveEmojiPicker.SKIN_COLORS[key]
        }
      }), {}))
    },
    skinTone_active: {
      opacity: 1,
      '@selectors': _extends({}, Object.keys(_interweaveEmojiPicker.SKIN_COLORS).reduce((colors, key) => _extends({}, colors, {
        ["[data-skin-tone=\"" + key + "\"]"]: {
