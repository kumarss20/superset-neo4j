...
export default function BaseRadioButton(_ref) {
  let {
    button,
    checked,
    children,
  ...
  const radioButton = React.createElement("label", {
    htmlFor: id,
  ...
  }, React.createElement(IconRecord, {
    decorative: true,
    size: "1.35em"
  ...
  }, radioButton, React.createElement("div", {
