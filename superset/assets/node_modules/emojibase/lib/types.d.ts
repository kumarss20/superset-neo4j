...
export declare type GroupKey = 'smileys-emotion' | 'people-body' | 'component' | 'animals-nature' | 'food-drink' | 'travel-places' | 'activities' | 'objects' | 'symbols' | 'flags';
export declare type Hexcode = string;
export declare type Presentation = 0 | 1;
export declare type PresentationKey = 'text' | 'emoji';
