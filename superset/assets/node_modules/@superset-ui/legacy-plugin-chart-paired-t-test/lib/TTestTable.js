...
_react.default.createElement(_reactableArc.Td,{key:c,column:a,data:b.group[c]}))});return d.push(_react.default.createElement(_reactableArc.Td,{key:l+1,className:a.getPValueStatus(c),column:"pValue",data:j[c]})),d.push(_react.default.createElement(_reactableArc.Td,{key:l+2,className:a.getLiftStatus(c),column:"liftValue",data:h[c]})),d.push(_react.default.createElement(_reactableArc.Td,{key:l+3,className:a.getSignificance(c).toString(),column:"significant",data:a.getSignificance(c)})),_react.default.createElement(_reactableArc.Tr,{key:c,onClick:a.computeTTest.bind(a,c),className:c===g?"control":""},d)}),n=e.concat([{column:"pValue",sortFunction:function sortFunction(c,a){return"control"===c?-1:"control"===a?1:c>a?1:-1;// p-values ascending
