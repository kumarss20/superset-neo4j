...
export function generateRichLineTooltipContent(a,b,c){var d="";return d+="<table><thead><tr><td colspan='3'>"+("<strong class='x-value'>"+b(a.value)+"</strong>")+"</td></tr></thead><tbody>",a.series.sort(function(c,a){return c.value>=a.value?-1:1}),a.series.forEach(function(a){var b=getFormattedKey(a.key,!0);d+="<tr class=\""+(a.highlight?"emph":"")+"\">"+("<td class='legend-color-guide' style=\"opacity: "+(a.highlight?"1":"0.75")+";\"\">")+"<div "+("style=\"border: 2px solid "+(a.highlight?"black":"transparent")+"; background-color: "+a.color+";\"")+"></div>"+"</td>"+("<td>"+b+"</td>")+("<td>"+c(a.value)+"</td>")+"</tr>"}),d+="</tbody></table>",dompurify.sanitize(d)}export function generateAreaChartTooltipContent(a,b,c){var d=a.series[a.series.length-1].value,e="";return e+="<table><thead><tr><td colspan='4'>"+("<strong class='x-value'>"+b(a.value)+"</strong>")+"</td></tr></thead><tbody>"+"<tr><td></td><td>Category</td><td>Value</td><td>% to total</td></tr>",a.series.forEach(function(a){var b=getFormattedKey(a.key,!0),f="";a.highlight?f="superset-legacy-chart-nvd3-tr-highlight":"TOTAL"===a.key&&(f="superset-legacy-chart-nvd3-tr-total"),e+="<tr class=\""+f+"\" style=\"border-color: "+a.color+"\">"+("<td style=\"color: "+a.color+"\">"+("TOTAL"===a.key?"":"&#9724;")+"</td>")+("<td>"+b+"</td>")+("<td>"+c(a.value)+"</td>")+("<td>"+(100*a.value/d).toFixed(2)+"%</td>")+"</tr>"}),e+="</tbody></table>",dompurify.sanitize(e)}export function generateMultiLineTooltipContent(a,b,c){var d=b(a.value),e="";return e+="<table><thead><tr><td colspan='3'>"+("<strong class='x-value'>"+d+"</strong>")+"</td></tr></thead><tbody>",a.series.forEach(function(a,b){var d=c[b],f=getFormattedKey(a.key,!1);e+="<tr><td class='legend-color-guide'>"+("<div style=\"background-color: "+a.color+";\"></div></td>")+("<td class='key'>"+f+"</td>")+("<td class='value'>"+d(a.value)+"</td></tr>")}),e+="</tbody></table>",e}export function generateTimePivotTooltip(a,b,c){var d=b(a.value),e="";return e+="<table><thead><tr><td colspan='3'>"+("<strong class='x-value'>"+d+"</strong>")+"</td></tr></thead><tbody>",a.series.forEach(function(a){if(a.highlight){var b="";b="current"===a.key?a.key:a.key+" of the selected frequency:",e+="<tr><td class='legend-color-guide'>"+("<div style=\"background-color: "+a.color+";\"></div></td>")+("<td class='key'>"+b+"</td>")+("<td class='value'>"+c(a.value)+"</td></tr>")}}),e+="</tbody></table>",dompurify.sanitize(e)}function getLabel(a){return a.label||a}function createHTMLRow(a,b){return"<tr><td>"+a+"</td><td>"+b+"</td></tr>"}export function generateBubbleTooltipContent(a){var b=a.point,c=a.entity,d=a.xField,e=a.yField,f=a.sizeField,g=a.xFormatter,h=a.yFormatter,i=a.sizeFormatter,j="<table>";return j+="<tr><td style=\"color: "+b.color+";\">"+("<strong>"+b[c]+"</strong> ("+b.group+")")+"</td></tr>",j+=createHTMLRow(getLabel(d),g(b.x)),j+=createHTMLRow(getLabel(e),h(b.y)),j+=createHTMLRow(getLabel(f),i(b.size)),j+="</table>",j}// shouldRemove indicates whether the nvtooltips should be removed from the DOM
export function hideTooltips(a){var b=document.querySelectorAll(".nvtooltip");0<b.length&&b.forEach(function(b){a?b.remove():b.style.opacity=0})}export function generateTooltipClassName(a){return"tooltip-"+a}export function removeTooltip(a){var b="."+generateTooltipClassName(a),c=document.querySelector(b);c&&c.remove()}export function wrapTooltip(a,b){var c=a.useInteractiveGuideline&&a.useInteractiveGuideline()?a.interactiveLayer:a,e=c.tooltip.contentGenerator();c.tooltip.contentGenerator(function(a){var c="<div style=\"max-width: "+.5*b+"px\">";return c+=e(a),c+="</div>",c})}export function tipFactory(a){return d3tip().attr("class","d3-tip").direction("n").offset([-5,0]).html(function(b){if(!b)return"";var c=b[a.titleColumn]&&b[a.titleColumn].length?b[a.titleColumn]+" - "+a.name:a.name,d=Array.isArray(a.descriptionColumns)?a.descriptionColumns.map(function(a){return b[a]}):/* eslint-disable-next-line compat/compat */Object.values(b);return"<div><strong>"+c+"</strong></div><br/><div>"+d.join(", ")+"</div>"})}export function getMaxLabelSize(a,b){// axis class = .nv-y2  // second y axis on dual line chart
...
var b=+a;return Number.isNaN(b)?a:b}export function stringifyTimeRange(a){return a.some(function(a){return void 0===a.toISOString})?null:a.map(function(a){return a.toISOString().slice(0,-1)}).join(" : ")}export function setAxisShowMaxMin(a,b){a&&a.showMaxMin&&b!==void 0&&a.showMaxMin(b)}export function computeYDomain(a){if(Array.isArray(a)&&0<a.length&&Array.isArray(a[0].values)){var b=a.filter(function(a){return!a.disabled}).map(function(a){return d3.extent(a.values,function(a){return a.y})}),c=d3.min(b,function(a){var b=a[0];return b}),d=d3.max(b,function(a){var b=a[1];return b});return[c,d]}return[0,1]}export function computeStackedYDomain(a){if(Array.isArray(a)&&0<a.length&&Array.isArray(a[0].values)){var b=a.filter(function(a){return!a.disabled}).map(function(a){return a.values.map(function(a){return a.y})}),c=b[0].map(function(a,c){return b.reduce(function(a,b){return a+b[c]},0)});return[Math.min.apply(Math,[0].concat(c)),Math.max.apply(Math,[0].concat(c))]}return[0,1]}