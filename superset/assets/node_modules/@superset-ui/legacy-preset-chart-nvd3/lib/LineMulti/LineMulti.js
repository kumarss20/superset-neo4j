...
if(e.data=(c=[]).concat.apply(c,a),h.length&&i.length){var f=1/0,g=-Infinity;e.data.forEach(function(a){f=Math.min.apply(Math,[f].concat(a.values.map(function(a){return a.x}))),g=Math.max.apply(Math,[g].concat(a.values.map(function(a){return a.x})))}),e.data.forEach(function(a){a.values.push({x:f,y:null}),a.values.push({x:g,y:null})})}b.setState({queryData:e})})},c.render=function render(){var a=this.state.queryData;return _react.default.createElement(_ReactNVD.default,(0,_transformProps.default)(_extends({},this.props,{queryData:a})))},b}(_react.default.Component);LineMulti.propTypes=propTypes,LineMulti.defaultProps=defaultProps;var _default=LineMulti;exports.default=_default;