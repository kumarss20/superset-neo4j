...
cellRadius:0,domainGutter:2,domainMargin:[0,0,0,0],valueFormatter:function valueFormatter(e){return e},timeFormatter:function timeFormatter(e){return e},domain:"hour",subDomain:"min",// Number of columns to split the subDomains to
...
afterLoadData:function afterLoadData(e){return e},// Callback triggered after calling and completing update().
...
// =========================================================================//
   ...
   */ /* jshint maxstatements:false */init:function init(e){'use strict';/**
...
if(!e.hasOwnProperty("label")||e.hasOwnProperty("label")&&!e.label.hasOwnProperty("align")){switch(i.label.position){case"left":i.label.align="right";break;case"right":i.label.align="left";break;default:i.label.align="center";}"left"===i.label.rotate?i.label.align="right":"right"===i.label.rotate&&(i.label.align="left")}e.hasOwnProperty("label")&&(!e.hasOwnProperty("label")||e.label.hasOwnProperty("offset"))||"left"!==i.label.position&&"right"!==i.label.position||(i.label.offset={x:10,y:15})}(),this._init()},/**
   ...
   */expandDateSetting:function expandDateSetting(e){'use strict';return Array.isArray(e)||(e=[e]),e.map(function(e){return"now"===e?new Date:!!(e instanceof Date)&&e}).filter(function(e){return!1!==e})},/**
   ...
   * @return void
   */fill:function fill(e){'use strict';/**
   ...
   *
   * @return String
   */formatStringWithObject:function formatStringWithObject(e,t){'use strict';for(var o in t)if(t.hasOwnProperty(o)){var n=new RegExp("\\{"+o+"\\}","gi");e=e.replace(n,t[o])}return e},// =========================================================================//
// EVENTS CALLBACK                              //
// =========================================================================//
/**
   ...
   */triggerEvent:function triggerEvent(e,t,o){'use strict';return!!(3===arguments.length&&o||null===this.options[e])||("function"==typeof this.options[e]?("function"==typeof t&&(t=t()),this.options[e].apply(this,t)):(console.log("Provided callback for "+e+" is not a function."),!1))},/**
   * Event triggered on a mouse click on a subDomain cell
   *
   * @param  Date    d    Date of the subdomain block
   * @param  int    itemNb  Number of items in that date
   */onClick:function onClick(e,t){'use strict';return this.triggerEvent("onClick",[e,t])},/**
   ...
   */onComplete:function onComplete(){'use strict';var e=this.triggerEvent("onComplete",[],this._completed);return this._completed=!0,e},/**
   * Event triggered after shifting the calendar one domain back
   *
   * @param  Date    start  Domain start date
   * @param  Date    end    Domain end date
   */afterLoadPreviousDomain:function afterLoadPreviousDomain(e){'use strict';var t=this;return this.triggerEvent("afterLoadPreviousDomain",function(){var o=t.getSubDomain(e);return[o.shift(),o.pop()]})},/**
   * Event triggered after shifting the calendar one domain above
   *
   * @param  Date    start  Domain start date
   * @param  Date    end    Domain end date
   */afterLoadNextDomain:function afterLoadNextDomain(e){'use strict';var t=this;return this.triggerEvent("afterLoadNextDomain",function(){var o=t.getSubDomain(e);return[o.shift(),o.pop()]})},/**
   ...
   */onMinDomainReached:function onMinDomainReached(e){'use strict';return this._minDomainReached=e,this.triggerEvent("onMinDomainReached",[e])},/**
   ...
   */onMaxDomainReached:function onMaxDomainReached(e){'use strict';return this._maxDomainReached=e,this.triggerEvent("onMaxDomainReached",[e])},checkIfMinDomainIsReached:function checkIfMinDomainIsReached(e,t){'use strict';this.minDomainIsReached(e)&&this.onMinDomainReached(!0),2===arguments.length&&this._maxDomainReached&&!this.maxDomainIsReached(t)&&this.onMaxDomainReached(!1)},checkIfMaxDomainIsReached:function checkIfMaxDomainIsReached(e,t){'use strict';this.maxDomainIsReached(e)&&this.onMaxDomainReached(!0),2===arguments.length&&this._minDomainReached&&!this.minDomainIsReached(t)&&this.onMinDomainReached(!1)},afterUpdate:function afterUpdate(){'use strict';return this.triggerEvent("afterUpdate")},// =========================================================================//
// FORMATTER                                //
// =========================================================================//
formatNumber:d3.format(",g"),formatDate:function formatDate(e,t){'use strict';if(2>arguments.length&&(t="title"),"function"==typeof t)return t(e);var o=d3.time.format(t);return o(e)},getSubDomainTitle:function getSubDomainTitle(e){'use strict';if(null===e.v&&!this.options.considerMissingDataAsZero)return this.formatStringWithObject(this.options.subDomainTitleFormat.empty,{date:this.formatDate(new Date(e.t),this.options.subDomainDateFormat)});var t=e.v;// Consider null as 0
...
/**
   ...
   */loadNextDomain:function loadNextDomain(e){'use strict';if(this._maxDomainReached||0===e)return!1;var t=this.loadNewDomains(this.NAVIGATE_RIGHT,this.getDomain(this.getNextDomain(),e));return this.afterLoadNextDomain(t.end),this.checkIfMaxDomainIsReached(this.getNextDomain().getTime(),t.start),!0},/**
   ...
   */loadPreviousDomain:function loadPreviousDomain(e){'use strict';if(this._minDomainReached||0===e)return!1;var t=this.loadNewDomains(this.NAVIGATE_LEFT,this.getDomain(this.getDomainKeys()[0],-e).reverse());return this.afterLoadPreviousDomain(t.start),this.checkIfMinDomainIsReached(t.start,t.end),!0},loadNewDomains:function loadNewDomains(e,t){'use strict';function o(e){return{t:n._domainType[n.options.subDomain].extractUnit(e),v:null}}// Remove out of bound domains from list of new domains to prepend
for(var n=this,a=e===this.NAVIGATE_LEFT,r=-1,l=t.length,d=this.getDomainKeys();++r<l;){if(a&&this.minDomainIsReached(t[r])){t=t.slice(0,r+1);break}if(!a&&this.maxDomainIsReached(t[r])){t=t.slice(0,r);break}}for(t=t.slice(-this.options.range),r=0,l=t.length;r<l;r++)this._domains.set(t[r].getTime(),this.getSubDomain(t[r]).map(o)),this._domains.remove(a?d.pop():d.shift());return d=this.getDomainKeys(),a&&(t=t.reverse()),this.paint(e),this.getDatas(this.options.data,t[0],this.getSubDomain(t[t.length-1]).pop(),function(){n.fill(n.lastInsertedSvg)}),{start:t[a?0:1],end:d[d.length-1]}},/**
   ...
   */maxDomainIsReached:function maxDomainIsReached(e){'use strict';return null!==this.options.maxDate&&this.options.maxDate.getTime()<e},/**
   * Return whether a date is inside the scope determined by minDate
   *
   * @param int datetimestamp The timestamp in ms to test
   * @return bool True if the specified date correspond to the calendar lower bound
   */minDomainIsReached:function minDomainIsReached(e){'use strict';return null!==this.options.minDate&&this.options.minDate.getTime()>=e},/**
   * Return the list of the calendar's domain timestamp
   *
   * @return Array a sorted array of timestamp
   */getDomainKeys:function getDomainKeys(){'use strict';return this._domains.keys().map(function(e){return parseInt(e,10)}).sort(function(e,t){return e-t})},// =========================================================================//
// POSITIONNING                                //
// =========================================================================//
positionSubDomainX:function positionSubDomainX(e){'use strict';var t=this._domainType[this.options.subDomain].position.x(new Date(e));return t*this.options.cellSize+t*this.options.cellPadding},positionSubDomainY:function positionSubDomainY(e){'use strict';var t=this._domainType[this.options.subDomain].position.y(new Date(e));return t*this.options.cellSize+t*this.options.cellPadding},getSubDomainColumnNumber:function getSubDomainColumnNumber(e){'use strict';if(0<this.options.rowLimit){var t=this._domainType[this.options.subDomain].maxItemNumber;return"function"==typeof t&&(t=t(e)),Math.ceil(t/this.options.rowLimit)}var o=this._domainType[this.options.subDomain].defaultColumnNumber;return"function"==typeof o&&(o=o(e)),this.options.colLimit||o},getSubDomainRowNumber:function getSubDomainRowNumber(e){'use strict';if(0<this.options.colLimit){var t=this._domainType[this.options.subDomain].maxItemNumber;return"function"==typeof t&&(t=t(e)),Math.ceil(t/this.options.colLimit)}var o=this._domainType[this.options.subDomain].defaultRowNumber;return"function"==typeof o&&(o=o(e)),this.options.rowLimit||o},/**
   * Return a classname if the specified date should be highlighted
   *
   * @param  timestamp date Date of the current subDomain
   * @return String the highlight class
   */getHighlightClassName:function getHighlightClassName(e){'use strict';if(e=new Date(e),0<this.options.highlight.length)for(var t in this.options.highlight)if(this.dateIsEqual(this.options.highlight[t],e))return this.isNow(this.options.highlight[t])?" highlight-now":" highlight";return""},/**
   ...
   */isNow:function isNow(e){'use strict';return this.dateIsEqual(e,new Date)},/**
...
/**
   ...
   */getWeekNumber:function getWeekNumber(e){'use strict';var t=!0===this.options.weekStartOnMonday?d3.time.format("%W"):d3.time.format("%U");return t(e)},/**
   * Return the week number, relative to its month
   *
   * @param  int|Date d Date or timestamp in milliseconds
   * @return int Week number, relative to the month [0-5]
   */getMonthWeekNumber:function getMonthWeekNumber(e){'use strict';"number"==typeof e&&(e=new Date(e));var t=this.getWeekNumber(new Date(e.getFullYear(),e.getMonth()));return this.getWeekNumber(e)-t-1},/**
   * Return the number of weeks in the dates' year
   *
   * @param  int|Date d Date or timestamp in milliseconds
   * @return int Number of weeks in the date's year
   */getWeekNumberInYear:function getWeekNumberInYear(e){'use strict';"number"==typeof e&&(e=new Date(e))},/**
   * Return the number of days in the date's month
   *
   * @param  int|Date d Date or timestamp in milliseconds
   * @return int Number of days in the date's month
   */getDayCountInMonth:function getDayCountInMonth(e){'use strict';return this.getEndOfMonth(e).getDate()},/**
   * Return the number of days in the date's year
   *
   * @param  int|Date d Date or timestamp in milliseconds
   * @return int Number of days in the date's year
   */getDayCountInYear:function getDayCountInYear(e){'use strict';return"number"==typeof e&&(e=new Date(e)),1===new Date(e.getFullYear(),1,29).getMonth()?366:365},/**
   ...
   */getWeekDay:function getWeekDay(e){'use strict';return!1===this.options.weekStartOnMonday?e.getDay():0===e.getDay()?6:e.getDay()-1},/**
   * Get the last day of the month
   * @param  Date|int  d  Date or timestamp in milliseconds
   * @return Date      Last day of the month
   */getEndOfMonth:function getEndOfMonth(e){'use strict';return"number"==typeof e&&(e=new Date(e)),new Date(e.getFullYear(),e.getMonth()+1,0)},/**
   *
   * @param  Date date
   * @param  int count
   * @param  string step
   * @return Date
   */jumpDate:function jumpDate(e,t,o){'use strict';var n=new Date(e);return"hour"===o?n.setHours(n.getHours()+t):"day"===o?n.setHours(n.getHours()+24*t):"week"===o?n.setHours(n.getHours()+7*(24*t)):"month"===o?n.setMonth(n.getMonth()+t):"year"===o?n.setFullYear(n.getFullYear()+t):void 0,new Date(n)},// =========================================================================//
// DOMAIN COMPUTATION                            //
// =========================================================================//
/**
   ...
   */getMinuteDomain:function getMinuteDomain(e,t){'use strict';var o=new Date(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours()),n=null;return n=t instanceof Date?new Date(t.getFullYear(),t.getMonth(),t.getDate(),t.getHours()):new Date(+o+60*(1e3*t)),d3.time.minutes(Math.min(o,n),Math.max(o,n))},/**
...
return"number"==typeof t&&a.length>Math.abs(t)&&a.splice(a.length-1,1),a},/**
   ...
   */getDayDomain:function getDayDomain(e,t){'use strict';var o=new Date(e.getFullYear(),e.getMonth(),e.getDate()),n=null;return t instanceof Date?n=new Date(t.getFullYear(),t.getMonth(),t.getDate()):(n=new Date(o),n=new Date(n.setDate(n.getDate()+parseInt(t,10)))),d3.time.days(Math.min(o,n),Math.max(o,n))},/**
   * Return all the weeks between 2 dates
   *
   * @param  Date  d  A date
   * @param  int|date  range  Number of minutes in the range, or a stop date
   * @return array  An array of weeks
   */getWeekDomain:function getWeekDomain(e,t){'use strict';var o;!1===this.options.weekStartOnMonday?o=new Date(e.getFullYear(),e.getMonth(),e.getDate()-e.getDay()):1===e.getDay()?o=new Date(e.getFullYear(),e.getMonth(),e.getDate()):0===e.getDay()?(o=new Date(e.getFullYear(),e.getMonth(),e.getDate()),o.setDate(o.getDate()-6)):o=new Date(e.getFullYear(),e.getMonth(),e.getDate()-e.getDay()+1);var n=new Date(o),i=t;return"object"!=typeof t&&(i=new Date(n.setDate(n.getDate()+7*t))),!0===this.options.weekStartOnMonday?d3.time.mondays(Math.min(o,i),Math.max(o,i)):d3.time.sundays(Math.min(o,i),Math.max(o,i))},/**
   * Return all the months between 2 dates
   *
   * @param  Date    d    A date
   * @param  int|date  range  Number of months in the range, or a stop date
   * @return array  An array of months
   */getMonthDomain:function getMonthDomain(e,t){'use strict';var o=new Date(e.getFullYear(),e.getMonth()),n=null;return t instanceof Date?n=new Date(t.getFullYear(),t.getMonth()):(n=new Date(o),n=n.setMonth(n.getMonth()+t)),d3.time.months(Math.min(o,n),Math.max(o,n))},/**
   * Return all the years between 2 dates
   *
   * @param  Date  d  date  A date
   * @param  int|date  range  Number of minutes in the range, or a stop date
   * @return array  An array of hours
   */getYearDomain:function getYearDomain(e,t){'use strict';var o=new Date(e.getFullYear(),0),n=null;return n=t instanceof Date?new Date(t.getFullYear(),0):new Date(e.getFullYear()+t,0),d3.time.years(Math.min(o,n),Math.max(o,n))},/**
   * Get an array of domain start dates
   *
   * @param  int|Date date A random date included in the wanted domain
   * @param  int|Date range Number of dates to get, or a stop date
   * @return Array of dates
   */getDomain:function getDomain(e,t){'use strict';switch("number"==typeof e&&(e=new Date(e)),2>arguments.length&&(t=this.options.range),this.options.domain){case"hour":var o=this.getHourDomain(e,t);// Case where an hour is missing, when passing from standard time to DST
// Missing hour is perfectly acceptabl in subDomain, but not in domains
return"number"==typeof t&&o.length<t&&(0<t?o.push(this.getHourDomain(o[o.length-1],2)[1]):o.shift(this.getHourDomain(o[0],-2)[0])),o;case"day":return this.getDayDomain(e,t);case"week":return this.getWeekDomain(e,t);case"month":return this.getMonthDomain(e,t);case"year":return this.getYearDomain(e,t);}},/* jshint maxcomplexity: false */getSubDomain:function getSubDomain(e){'use strict';"number"==typeof e&&(e=new Date(e));var t=this,o=function(e,o){return"year"===o?t.getDayCountInYear(e):"month"===o?t.getDayCountInMonth(e):"week"===o?7:void 0},n=function(e,t){return"hour"===t?60:"day"===t?60*24:"week"===t?7*(60*24):void 0},i=function(e,o){return"day"===o?24:"week"===o?168:"month"===o?24*t.getDayCountInMonth(e):void 0},a=function(e,o){if("month"===o){var n=new Date(e.getFullYear(),e.getMonth()+1,0),i=t.getWeekNumber(n),a=t.getWeekNumber(new Date(e.getFullYear(),e.getMonth()));return a>i&&(a=0,i++),i-a+1}return"year"===o?t.getWeekNumber(new Date(e.getFullYear(),11,31)):void 0};/**
     * @return int
   ...
   */getNextDomain:function getNextDomain(e){'use strict';return 0===arguments.length&&(e=1),this.getDomain(this.jumpDate(this.getDomainKeys().pop(),e,this.options.domain),1)[0]},/**
   * Get the n-th domain before the calendar oldest (leftmost) domain
   * @param  int n
   * @return Date The start date of the wanted domain
   */getPreviousDomain:function getPreviousDomain(e){'use strict';return 0===arguments.length&&(e=1),this.getDomain(this.jumpDate(this.getDomainKeys().shift(),-e,this.options.domain),1)[0]},// =========================================================================//
// DATAS                                  //
// =========================================================================//
/**
...
if(null!==r.options.dataRequestHeaders)for(var p in r.options.dataRequestHeaders)r.options.dataRequestHeaders.hasOwnProperty(p)&&g.header(p,r.options.dataRequestHeaders[p]);return g.send(m,s,l),!1;case"object":if(e===Object(e))return l(null,e),!1;/* falls through */default:return l(null,{}),!0;}},/**
   ...
   *
   * @return void
   */parseDatas:function parseDatas(e,t,o,n){'use strict';t===this.RESET_ALL_ON_UPDATE&&this._domains.forEach(function(e,t){t.forEach(function(e,t,o){o[t].v=null})});var i={},a=function(e){return e.t};/*jshint forin:false */for(var r in e){var l=new Date(1e3*r),d=this.getDomain(l)[0].getTime();// Skip if data is not relevant to current domain
if(0<=this.DSTDomain.indexOf(d)&&this._domains.has(d-1e3*3600)&&(d-=1e3*3600),!isNaN(r)&&e.hasOwnProperty(r)&&this._domains.has(d)&&d>=+o&&d<+n){var m=this._domains.get(d);i.hasOwnProperty(d)||(i[d]=m.map(a));var s=i[d].indexOf(this._domainType[this.options.subDomain].extractUnit(l));t===this.RESET_SINGLE_ON_UPDATE?m[s].v=e[r]:isNaN(m[s].v)?m[s].v=e[r]:m[s].v+=e[r]}}},parseURI:function parseURI(e,t,o){'use strict';// Use a timestamp in seconds
return e=e.replace(/\{\{t:start\}\}/g,t.getTime()/1e3),e=e.replace(/\{\{t:end\}\}/g,o.getTime()/1e3),e=e.replace(/\{\{d:start\}\}/g,t.toISOString()),e=e.replace(/\{\{d:end\}\}/g,o.toISOString()),e},interpretCSV:function interpretCSV(e){'use strict';var t,o,n={},a=Object.keys(e[0]);for(t=0,o=e.length;t<o;t++)n[e[t][a[0]]]=+e[t][a[1]];return n},/**
...
/**
   ...
   */jumpTo:function jumpTo(e,t){'use strict';2>arguments.length&&(t=!1);var o=this.getDomainKeys(),n=o[0],i=o[o.length-1];if(e<n)return this.loadPreviousDomain(this.getDomain(n,e).length);return t?this.loadNextDomain(this.getDomain(n,e).length):!!(e>i)&&this.loadNextDomain(this.getDomain(i,e).length)},/**
   ...
   */update:function update(e,t,o){'use strict';0===arguments.length&&(e=this.options.data),2>arguments.length&&(t=!0),3>arguments.length&&(o=this.RESET_ALL_ON_UPDATE);var n=this.getDomainKeys(),i=this;this.getDatas(e,new Date(n[0]),this.getSubDomain(n[n.length-1]).pop(),function(){i.fill(),i.afterUpdate()},t,o)},/**
   * Set the legend
   *
   ...
   */setLegend:function setLegend(){'use strict';var e=this.options.legend.slice(0);1<=arguments.length&&Array.isArray(arguments[0])&&(this.options.legend=arguments[0]),2<=arguments.length&&(Array.isArray(arguments[1])&&2<=arguments[1].length?this.options.legendColors=[arguments[1][0],arguments[1][1]]:this.options.legendColors=arguments[1]),(0<arguments.length&&!arrayEquals(e,this.options.legend)||2<=arguments.length)&&(this.Legend.buildColors(),this.fill()),this.Legend.redraw(this.graphDim.width-this.options.domainGutter-this.options.cellPadding)},/**
   * Remove the legend
   *
   * @return bool False if there is no legend to remove
   */removeLegend:function removeLegend(){'use strict';return!!this.options.displayLegend&&(this.options.displayLegend=!1,this.Legend.remove(),!0)},/**
   * Display the legend
   *
   * @return bool False if the legend was already displayed
   */showLegend:function showLegend(){'use strict';return!this.options.displayLegend&&(this.options.displayLegend=!0,this.Legend.redraw(this.graphDim.width-this.options.domainGutter-this.options.cellPadding),!0)},/**
   * Highlight dates
   *
   ...
   */highlight:function highlight(e){'use strict';return!!(0<(this.options.highlight=this.expandDateSetting(e)).length)&&(this.fill(),!0)},/**
   ...
   * @return null
   */destroy:function destroy(e){'use strict';return this.root.transition().duration(this.options.animationDuration).attr("width",0).attr("height",0).remove().each("end",function(){"function"==typeof e?e():"undefined"!=typeof e&&console.log("Provided callback for destroy() is not a function.")}),null},getSVG:function getSVG(){'use strict';for(var e={".cal-heatmap-container":{},".graph":{},".graph-rect":{},"rect.highlight":{},"rect.now":{},"rect.highlight-now":{},"text.highlight":{},"text.now":{},"text.highlight-now":{},".domain-background":{},".graph-label":{},".subdomain-text":{},".q0":{},".qi":{}},t=1,o=this.options.legend.length+1;t<=o;t++)e[".q"+t]={};var n=this.root,a=[// SVG specific properties
