...
export declare type LabelOverlapStrategy = 'auto' | 'flat' | 'rotate';
...
export declare type Axis = Partial<CoreAxis>;
...
export declare function isAxis(axis: Axis | null | undefined | false): axis is Axis;
