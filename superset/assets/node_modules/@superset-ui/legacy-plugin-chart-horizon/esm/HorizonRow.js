...
for(var A=p;A<q;A++)(r=m[A].y,!(0<=r))&&n.fillRect(k+A*o,w(-r),o+1,w(0)-w(-r))}}}},c.render=function render(){var a=this,b=this.props,c=b.className,d=b.title,e=b.width,f=b.height;return React.createElement("div",{className:"horizon-row "+c},React.createElement("span",{className:"title"},d),React.createElement("canvas",{width:e,height:f,ref:function ref(b){a.canvas=b}}))},b}(React.PureComponent);HorizonRow.propTypes=propTypes,HorizonRow.defaultProps=defaultProps;export default HorizonRow;